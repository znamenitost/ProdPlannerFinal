...
public class TaskTableServiceResult<T>
{
    ...
    public int? ReplacedTaskId { get; init; }
    ...
    public static TaskTableServiceResult<T> Reassigned(T data, int replacedTaskId) =>
        new() { Data = data, ReplacedTaskId = replacedTaskId };
}
